 ...
 * Spacewalk 2.5 instructions are available at [wiki:RegisteringClients25].
 * Spacewalk 2.4 instructions are available at [wiki:RegisteringClients24].
 * Spacewalk 2.3 instructions are available at [wiki:RegisteringClients23].
 * Spacewalk 2.2 instructions are available at [wiki:RegisteringClients22].
 * Spacewalk 2.1 instructions are available at [wiki:RegisteringClients21].
 * Spacewalk 2.0 instructions are available at [wiki:RegisteringClients20].
 * Spacewalk 1.9 instructions are available at [wiki:RegisteringClients19].
 * Spacewalk 1.8 instructions are available at [wiki:RegisteringClients18].
...
'''NOTE: DEBIAN PACKAGES ARE NOT YET UPDATED FOR SPACEWALK-2.6! ''' Any volunteers?
