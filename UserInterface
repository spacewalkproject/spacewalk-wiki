 ...
 * looks fixed
 * [master-bootstrap-css-fixes e6cfd68] if it is the same thing
...
* ~~/rhn/systems/ssm/MigrateSystems.do popup menu (aka select) after 'Target Orgenization' is not styled~~ fixed by duncan [master-bootstrap-css-fixes 97cc7c7]
...
* ~~Unstyled elements:~~ fixed by duncan [master-bootstrap-css-fixes 23b7285]
...
* List pagination and alpha bar
  * ~~bar goes from 0..9A..Z on /rhn/systems/details/packages/PackageList.do but A..Z0..9 on /rhn/systems/SystemEntitlements.do and /network/systems/system_list/regular_in_channel_family.pxt~~ Fixed by duncan [master-bootstrap-css-fixes c245169]
  ...
  * ~~different set of pagination arrows on /network/systems/system_list/regular_in_channel_family.pxt~~ fixed by duncan [master-bootstrap-css-fixes 90ed0c7]
...
* ~~/rhn/admin/config/MonitoringConfig.do~~ not bootstrap specific (2.0 has it too) fixed by duncan [master-bootstrap-css-fixes 12b3302]
...
* ~~/rhn/systems/details/packages/InstallPackages.do?sid=1000010001~~ fixed by duncan [master-bootstrap-css-fixes 8839652]
