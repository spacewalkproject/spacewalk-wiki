...
Instructions for registering client systems you wish to manage with Spacewalk 1.9
...
== Fedora ==
 ...
 1. Install the Spacewalk client yum repository
    * For Fedora 18:
{{{
# rpm -Uvh http://yum.spacewalkproject.org/1.9/Fedora/18/x86_64/spacewalk-client-repo-1.9-1.fc18.noarch.rpm
}}}
    * For Fedora 17:
{{{
# rpm -Uvh http://yum.spacewalkproject.org/1.9/Fedora/17/x86_64/spacewalk-client-repo-1.9-1.fc17.noarch.rpm
}}}
 ...
 * RHEL 5 / CentOS 5
   {{{
# BASEARCH=$(uname -i)
# rpm -Uvh http://yum.spacewalkproject.org/1.9/RHEL/5/$BASEARCH/spacewalk-client-repo-1.9-1.el5.noarch.rpm
   }}}
