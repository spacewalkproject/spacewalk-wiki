...
These are installation instructions for new installations of Spacewalk 2.0. If you are upgrading from older versions, see [wiki:HowToUpgrade20].

Spacewalk 1.9 installation instructions are available at [wiki:HowToInstall19].
