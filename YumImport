...
Mapping between com.redhat.rhn.domain.rhnpackage.Package ''domain'' object and YUM metadata.

|| '''Package Field''' || '''Description''' || '''Yum Metadata''' ''<document>'':''<xpath>'' ||
|| id || unique package identifier || primary.xml:/package/checksum ||
|| rpmVersion || The version of the RPM tool? || ''none'' ||
...
|| md5sum || The package md5 || primary.xml:/package/checksum[@type="md5"] ||
...
|| changeLog || The rpm changelog || other.xml:/otherdata/package[@pkgid=''checksum'']/changelog ||
