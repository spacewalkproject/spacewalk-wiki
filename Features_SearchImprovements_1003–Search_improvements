...
||1003-01 || Filter by events by package || [https://bugzilla.redhat.com/show_bug.cgi?id=472889 bug 472889]|| Concern about request for breaking package install into fine grained/individual transactions, sounds similar to case with errata where individual errata actions cause excess network I/O and poor performance  ||
...
||1003-03 || Need to be able to monitor progress of errata updates on satellite to verify when they complete  || [https://bugzilla.redhat.com/show_bug.cgi?id=481626 bug 481626]|| Probably can monitor taskomatic queue for errata actions and provide updates from that ||
