...
This page is now obsolete. See [wiki:RegisteringClients Registering Clients] for up-to-date instructions.
...
* [http://docs.fedoraproject.org/deployment-guide/f12/en-US/html/ Deployment, configuration and administration of Fedora 12]