 ...
 * Spacewalk 1.0 to 1.1 upgrade instructions, are available at [wiki:HowToUpgrade11]
 * Spacewalk 0.8 to 1.0 upgrade instructions, are available at [wiki:HowToUpgrade10]
