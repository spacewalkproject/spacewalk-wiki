...
These upgrade instruction apply to Spacewalk installations meeting the following criteria:
  ...
  *  Spacewalk 2.4 running on Red Hat Enterprise Linux/CentOS/Scientific Linux 6 Server, or Fedora 22.
...
== Assumptions ==
  ...
  * You have set up your yum to point to Spacewalk 2.5 repository. For the repo setup specifics, see HowToInstall#SettingupSpacewalkrepo.
