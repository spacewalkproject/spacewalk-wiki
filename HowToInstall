...
Spacewalk 2.0 installation instructions are available at [wiki:HowToInstall20].
...
{{{
rpm -Uvh http://yum.spacewalkproject.org/2.1/Fedora/19/x86_64/spacewalk-repo-2.1-2.fc19.noarch.rpm
}}}
