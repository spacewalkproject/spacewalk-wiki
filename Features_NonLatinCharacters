...
There exist [http://download.oracle.com/javase/6/docs/api/java/net/IDN.html library java.net.IDN] directly in java, which contains IDN bindings. Usage is similar as in Perl example above.

 
=== Python ===

We can use module [http://docs.python.org/release/2.3.2/lib/module-encodings.idna.html encodings.idna].
