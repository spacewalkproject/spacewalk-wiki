...
||G3||Query File List||Publish ''final'' list of files containing queries that need to be tagged.  This item will be created by merging script task(s) output|| done || jortel || Included in G7||
...
Here is the assignment table for migrating the table DDL.  Please put you name in the ''Assigned'' column __before__ you begin working on a table.  Start by copying
...
Also, please note any items of interest in the ''notes'' column and be sure to follow the [wiki:PostgresPortingGuidelines porting guidelines].

[wiki:PgportTables Table Migration].

=== View Migration ===

Here is the assignment table for migrating the view DDL.  Please put you name in the ''Assigned'' column __before__ you begin working on a view.  Start by copying
...
[wiki:PgportViews View Migration].

=== Stored Procedure Migration ===

Here is the assignment table for migrating the stored procedures __not__ associated with a package.  Please put you name in the ''Assigned'' column __before__ you begin 
...
Then proceed with the migration.  Also, please note any items of interest in the ''notes'' column and sure to follow the [wiki:PostgresPortingGuidelines porting guidelines].

[wiki:PgportProcedures Stored Procedure Migration]

=== Trigger Migration ===
[wiki:PgportTriggers Trigger Migration status]
