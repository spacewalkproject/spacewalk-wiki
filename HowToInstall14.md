...
Spacewalk 1.3 installation instructions are available at [wiki:HowToInstall13].
...
java.io.!FileNotFoundException: /usr/share/tomcat6/logs/catalina.2011-02-03.log (Permission denied)
 in /var/log/tomcat6/catalina.out on RHEL6. The reason is a [https://bugzilla.redhat.com/show_bug.cgi?id=634863 bug] in tomcat6.
Workaround:
{{{
