...
In some cases, your firewall or network settings may cause osad's to think they're still connected when they're not. A number of possible solution for this are discussed in [wiki:JabberAndOSAD the Jabber and OSAD] section.
...
[https://fedorahosted.org/spacewalk/wiki/JabberAndOSAD Jabber and OSAD client connection issues]
=== Resources ===
