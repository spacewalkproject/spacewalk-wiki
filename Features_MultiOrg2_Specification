...
The design of the following new pages can be found on the [https://fedorahosted.org/spacewalk/wiki/Features/MultiOrg2/TrustRelationships User Interface] mockups and the [https://fedorahosted.org/spacewalk/wiki/Features/MultiOrg2/ContentSharing Content Sharing] mockups. High Level descriptions of the widgets can be found on the mockup pages. A diagram representing the new and existing pages can be found at [https://fedorahosted.org/spacewalk/wiki/Features/MultiOrg2].
